...
macro "rot" : tactic => `(tactic|
  egg [comm_add, comm_mul, add_assoc, mul_assoc, sub_canon, sub_cancel, sub_add_assoc, neg_add,
  ...
  factorial_zero, binomial_helper, inductive_hypothesis]
)
